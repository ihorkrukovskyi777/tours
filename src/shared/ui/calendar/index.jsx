...
export default function Calendar({title="Bogota Tour Calendar", children , size='large' , opened=false , nextStep}) {
...
const updateCalendar = () => {
  ...
  return (
    <div className="calendar">
        <HeaderCalendar month={currentMonth} year={currentYear} prevMonth={prevMonth} nextMonth={nextMonth} disableArrow={disableClass} />
        <DaysHeader/>
        <div id="days">
            <Days lists={calendarData?.days} nextStep={nextStep}/>
        </div>
    </div>
  );
}
