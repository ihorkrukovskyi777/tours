...
import ModalBookingEdit from '@/entities/calendar/ui/modal-booking-edit';
...
function isOpenedThankYouModal  () {
    thankYouModal ? setThankYouModal(false) : setThankYouModal(true);
}

function isOpenedModal () {
    contactGuide ? setContactGuide(false)  : setContactGuide(true);
}
...
function closeCalendar() {}
    return (
        <section className="checkout_section">
            ...
            <DefaultModal modalShow={thankYouModal} isOpenedModal={isOpenedThankYouModal} size="middle" >
                <ThankYouMessage isOpenedThankYouModal={isOpenedThankYouModal} />
            </DefaultModal>
