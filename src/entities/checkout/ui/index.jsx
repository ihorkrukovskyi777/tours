...
import EditModalTour from "./edit-tour-modal";
import Button from "@/shared/ui/selectors/button/button";
import FormContactGuide from "./form-contact-guide";
import { useState, useEffect } from "react";
import FormEdit from "./form-edit";
import { getCountryPhone } from "@/entities/api";
import ModalBookingEdit from "@/entities/calendar/ui/modal-booking-edit/index";
  ...
  return (
    <section className="checkout_section">
      ...
      <EditModalTour ModalShow={showmodal}>
        ...
        <Button customClass="btn_wrap" onClick={modalOpen}>
      ...
      <DefaultModal
        modalShow={contactGuide}
        isOpenedModal={isOpenedModal}
        size="default"
      >
        <FormContactGuide
          isOpenedModal={isOpenedModal}
          isOpenedThankYouModal={isOpenedThankYouModal}
        />
      </DefaultModal>

      <DefaultModal
        modalShow={thankYouModal}
        isOpenedModal={isOpenedThankYouModal}
        size="middle"
      >
